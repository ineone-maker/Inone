...
- Rolled back to 6.0.4 code base for stability
- Incremented version number for pub.dev publishing compatibility
- Maintained all the stability improvements from the 6.0.4 version
